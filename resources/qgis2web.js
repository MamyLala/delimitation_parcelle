...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 10, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [47.760256, -14.265351, 48.989029, -13.303381],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([47.715771, -14.039469, 48.807714, -13.534434], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Délimitation des parcelles de reboisement (Suivi) - 2025</h2>';
        return titleElement;
    })(),
